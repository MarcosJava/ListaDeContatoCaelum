...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    ListaContatosViewController *lista = [ListaContatosViewController new]; //instancia a view que ira ser start
    
    UINavigationController *nav = [[UINavigationController alloc] initWithRootViewController:lista]; // usa navegation view e fala qual Controller sera o start
    
    self.window.rootViewController = nav; //informa o start
